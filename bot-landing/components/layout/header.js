    ...
    <>
      <header
        ...
        className={cn(
          ...
          scrolled
            ? "bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg border-b border-gray-100 shadow-sm dark:border-gray-800"
            : "bg-gray-100/50 dark:bg-gray-900/80 backdrop-blur-md"
        )}
      >
