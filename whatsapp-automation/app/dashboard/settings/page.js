          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-2 gap-2">
            <div className="space-y-1">
              ...
              {isEdit ? (
                ...
                <p className="p-3 sm:text-base text-sm  text-gray-800 dark:text-gray-200">
                  {formData.name}
                </p>
              )}
            </div>
            ...
            <div className="space-y-1">
              ...
              {isEdit ? (
                ...
                <div className="flex sm:flex-row flex-col sm:items-center items-start sm:justify-between p-3">
                  ...
                  {profileData?.isVerified ? (
                    ...
                    >
                      <FiXCircle className="mr-1" /> Verify
                    </button>
                  )}
                </div>
              )}
