    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
          ...
          <div>
            ...
            <form className="flex flex-col sm:flex-row gap-3">
              <input
                ...
                className="px-4 py-2 rounded-lg bg-gray-800 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-400 flex-grow"
                required
              />
              <button
                type="submit"
              ...
              <div className="flex space-x-4">
                {[
                  ...
                  <a
                    key={social.name}
                    href="#"
                    className="text-gray-400 hover:text-green-400 text-xl transition-colors duration-200"
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center">
            <span className="text-gray-500 text-sm mr-2">Certified:</span>
            <div className="flex space-x-3">
              <div className="bg-gray-800 px-3 py-1 rounded text-xs font-medium text-gray-300">
                GDPR Compliant
              </div>
              <div className="bg-gray-800 px-3 py-1 rounded text-xs font-medium text-gray-300">
                ISO 27001
