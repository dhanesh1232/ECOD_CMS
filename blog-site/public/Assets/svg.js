...
export const TrustSVG = () => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 200 60" // Adjusted viewBox to match the coordinates
  ...
  >
    {/* E */}
    <path d="M10 10V50H50V40H20V30H40V20H20V10H10Z" fill="currentColor" />
    {/* C */}
    <path
      d="M70 10V50H110V40H80V20H110V10H70Z"
      fill="currentColor"
      fillOpacity="0.8" // camelCase for React
    />
    {/* O */}
    <circle cx="145" cy="30" r="20" fill="currentColor" fillOpacity="0.6" />
    <circle cx="145" cy="30" r="15" fill="white" />
    {/* D */}
    <path
      d="M170 10V50H200V40H180V20H200V10H170Z"
      fill="currentColor"
      fillOpacity="0.4" // camelCase for React
    />
  </svg>
);
