                          ...
                          className={`flex items-center gap-1 font-medium ${
                            isHomePage
                              ? navScrolled
                                ...
                                : "text-white/90"
                              : "text-gray-800"
                          } dark:text-gray-200 ${navScrolled ? "hover:text-blue-800" : "hover:text-blue-200"} dark:hover:text-blue-400 transition-colors transform ease-in-out duration-150`}
                        ...
                        className={`px-3 py-2 font-medium ${
                          isHomePage
                            ? navScrolled
                              ...
                              : "text-white/90"
                            : "text-gray-800"
                        } dark:text-gray-200 ${navScrolled ? "hover:text-blue-800" : "hover:text-blue-200"} dark:hover:text-blue-400 transform ease-in-out duration-150 transition-colors rounded-lg block`}
                      >
                        {item.label}
                      </Link>
                    )}
