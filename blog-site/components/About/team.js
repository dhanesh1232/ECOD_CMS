...
const TeamMemberCard = ({ data }) => {
  ...
  if (!data)
    return (
      <div className="bg-gradient-to-br from-gray-100 to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl shadow animate-pulse h-80 w-full"></div>
    );
  ...
  return (
    <>
      <motion.div
        ...
        whileHover={{ y: -5 }}
        className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow hover:shadow-md transition-all duration-300 cursor-pointer group h-full flex flex-col border border-gray-100 dark:border-gray-700"
          ...
          >
            ...
            <div className="fixed inset-0 overflow-y-auto">
              <div className="flex min-h-full items-center justify-center p-4">
                ...
                >
                  <Dialog.Panel className="relative w-full max-w-md transform overflow-hidden rounded-2xl bg-white dark:bg-gray-800 shadow-lg">
                    <button
