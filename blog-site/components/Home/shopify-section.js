...
const ShopifySection = () => {
  ...
  const [activeRadarIndex, setActiveRadarIndex] = useState(null);
    ...
    <LazyMotion features={domAnimation}>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            {[
              ...
              <motion.div
                key={index}
                whileHover={{ y: -5 }}
                className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-6 rounded-xl border border-gray-200/30 dark:border-gray-700/30 shadow-sm hover:shadow-md transition-all"
              >
          ...
          >
            <div
              className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/30 dark:border-gray-700/30 shadow-lg hover:shadow-xl transition-all"
                    ...
                    <Pie
                      ...
                      label={({ name, percent }) => (
                        <text
                          ...
                          fontWeight={500}
                          style={{
                            opacity: activePieIndex === null ? 1 : 0.3,
            ...
            <div
              className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/30 dark:border-gray-700/30 shadow-lg hover:shadow-xl transition-all"
              onMouseLeave={() => setActiveRadarIndex(null)}
            >
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-6">
              ...
              <div className="h-[400px]">
                <ResponsiveContainer width="100%" height="100%">
                  <RadarChart
                    ...
                    onMouseEnter={(e) => {
                      if (e.activeLabel) {
                        const index = radarData.findIndex(
                          (item) => item.subject === e.activeLabel
                        );
                  ...
                  >
                    ...
                    <PolarAngleAxis
                      ...
                      tick={{
                        ...
                        fontSize: 12,
                        fontWeight:
                          activeRadarIndex !== null
                            ? (_, i) => (i === activeRadarIndex ? 600 : 400)
                            : 400,
                      }}
                    />
                    <PolarRadiusAxis
                    ...
                    <Radar
                      ...
                      stroke="#3b82f6"
                      fill="#3b82f6"
                      fillOpacity={activeRadarIndex === null ? 0.2 : 0.1}
                      strokeWidth={activeRadarIndex === null ? 2 : 3}
                      dot={{
                        r: activeRadarIndex === null ? 3 : 5,
                        fill: "#3b82f6",
                        stroke: "#fff",
                        strokeWidth: activeRadarIndex === null ? 1 : 2,
                      }}
                      activeDot={{
                        r: 6,
                        stroke: "#fff",
                                  ...
                                  <>
                                    ...
                                    <span
                                      className={`font-medium ${
                                        entry.value >= entry.payload.target
                                          ? "text-green-500"
                                          : "text-orange-500"
                                      }`}
                                    >
