...
import { Quote, Star, ChevronRight, ChevronLeft, X } from "lucide-react";
      ...
      <section className="w-full py-20 px-6 sm:px-8 bg-gradient-to-l from-gray-50/50 via-white/50 to-gray-50/50 dark:from-gray-900/50 dark:via-gray-800/50 dark:to-gray-900/50 backdrop-blur-sm text-center relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.h2 className="text-4xl sm:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 leading-tight">
              Client Testimonials
            </motion.h2>
            <motion.p
          ...
          >
            ...
            <button
              onClick={handlePrev}
              className="absolute left-4 top-1/2 z-10 -translate-y-1/2 w-10 h-10 flex items-center justify-center rounded-full bg-white/80 dark:bg-gray-800/80 backdrop-blur-md shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200/50 dark:border-gray-700/30 hover:scale-110"
            ...
            <button
              onClick={handleNext}
              className="absolute right-4 top-1/2 z-10 -translate-y-1/2 w-10 h-10 flex items-center justify-center rounded-full bg-white/80 dark:bg-gray-800/80 backdrop-blur-md shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200/50 dark:border-gray-700/30 hover:scale-110"
