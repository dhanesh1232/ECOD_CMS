...
const ShopifySection = () => {
  // Combine all inView checks to reduce re-renders
    ...
    <LazyMotion features={domAnimation}>
      ...
      >
        ...
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
          <div className="absolute top-20 left-10 w-64 h-64 rounded-full bg-blue-400/10 dark:bg-blue-500/10 blur-3xl animate-pulse"></div>
          <div className="absolute bottom-20 right-10 w-64 h-64 rounded-full bg-purple-400/10 dark:bg-purple-500/10 blur-3xl animate-pulse"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            {shopify_services_data.map((service, index) => (
              ...
              >
                <Link href={`${service.link}`} prefetch={false}>
          ...
          >
            <div className="relative max-w-2xl mx-auto bg-white/70 dark:bg-gray-800/60 backdrop-blur-lg rounded-2xl p-8 sm:p-10 border border-gray-200/50 dark:border-gray-700/30 shadow-lg overflow-hidden">
              {/* Decorative elements */}
              <div className="absolute -top-20 -left-20 w-64 h-64 rounded-full bg-blue-400/10 dark:bg-blue-500/10 blur-2xl -z-10 animate-pulse"></div>
              <div className="absolute -bottom-20 -right-20 w-64 h-64 rounded-full bg-purple-400/10 dark:bg-purple-500/10 blur-2xl -z-10 animate-pulse"></div>
