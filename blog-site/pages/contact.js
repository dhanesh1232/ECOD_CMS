...
const Contact = () => {
  ...
  return (
    <>
      ...
      />
      <section className="max-w-6xl mx-auto px-4 sm:px-8 md:px-14 py-6 bg-gray-100 dark:bg-gray-900 rounded-lg shadow-lg">
        <BackAndForward forward="/contact" />
        <hr className="my-4 w-full border-black" />
        <div className="w-full sm:px-4 lg:px-8">
          <h1 className="text-2xl md:text-4xl font-bold text-gray-900 dark:text-white text-center mb-2">
            Contact Us
          </h1>
...
{
  /*<section className="max-w-6xl py-6 bg-gradient-to-r from-blue-50 to-purple-50">
