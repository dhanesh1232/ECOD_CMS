...
const Contact = () => {
  ...
  return (
    <>
      ...
      <section className="max-w-7xl min-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 pb-8 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
